...
def get_df(type_count_dict):
    ...
    df.columns = ["OSP_QUEUE_NAME", "TYPOLOGY", "FROM_TASK", "TO_TASK", "Type", "Failures"]
    df = df[[ "Type", "TYPOLOGY", "OSP_QUEUE_NAME", "FROM_TASK", "TO_TASK", "Failures"]]
...
def groupby_all_typology(df):
    ...
    df['Category']='murex'
    df=df[['Category','Level1','Level2','Level3','Level4','Level5','Failures']]
...
##    logtype="OSP"
    ...
    print(unique_queue)
    master_data(output_path,master_path,contractid_dict,unique_queue)
