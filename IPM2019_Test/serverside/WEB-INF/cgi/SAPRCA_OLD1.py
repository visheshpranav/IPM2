...
##                    tcode_group[search_value][0].add(Tcode)
                    tcode_group[search_value][0]=tcode_group[search_value][0]+len(doc['user_count']['buckets'])
                    tcode_group[search_value][1]=tcode_group[search_value][1]+doc['doc_count']
...
##                    tcode_group[search_value][0].add(Tcode)
    ...
    for i in csvworkstream_data:
        ...
        for val in tcode_group:
            if val == spli_arr[3]:
                spli_arr[5] = str(tcode_group[val][0])
                spli_arr[7] = str(tcode_group[val][1])
        spli_str = ','.join(spli_arr)
