...
##        template_name = "TRD_MXInstant"
##        base_name = "UAT_test1"
##        compare_name = "UAT_Test2"
##        comparison_reportname = "C_new_5_1"
...
##        print(base_master_df.columns,compare_master_df.columns)
        if 'tradeType' in result_df.columns:
            ...
            cols = list(set(cols))
            generate_dendo_old(result_df,compare_output_path,cols,comparison_reportname,'Compare')
##        generate_dendo(result_df,compare_output_path,cols,comparison_reportname,'Compare')
