...
def generate_dendo(master_df,output_path):
    ...
    dendo_list = []
    groupby_df = master_df.groupby(['Category','tradeFamily','tradeGroup','typology','Trade Characteristics'])
...
##    print(files)	
    ...
    master_df = pd.DataFrame(columns = ['Category','tradeFamily','tradeGroup','typology','Trade Characteristics',
                                       ...
                                       'expiryDate','futureDisplayLabel','nominalAmount','currency','tradeInternalId'])	
    for file in files:
