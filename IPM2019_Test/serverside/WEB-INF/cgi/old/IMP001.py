    ...
    for Outcome in Outcomes:
        if Outcome == "csv":
            if mode == "OFL":
                ...
                usagefile.close()
                shutil.move(filename, "../../../html/Reports/"+str(userid)+"_"+str(rep_id)+"/"+filename)
            if mode == "ONL":
...
if __name__ == "__main__":
    ...
    matched_patterns = "P7,P3,P4"
    userid = ""
    rep_id = ""
    rep_name = ""
    Outcome = "json,csv"
    Logic = "THEN"
    logpath_file = "C:\\LAPAM2019\\DataLake\\Online\\SystemOut_18.11.18_23.00.00.log"
    mode = "ONL"
    appName = "TWA"
