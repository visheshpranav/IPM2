...
def dist_type(type_list):
    ...
    for i in range(len(unique_list)):
        ...
        for val in range(type_list_counter,type_list_counter+seq_val[1]):
            if type_list[val] in queue_count and val==type_list_counter:
                queue_count[type_list[val]] += 1
                final_queue_name = type_list[val].split('!@#')[0]+'_'+str(queue_count[type_list[val]])
