        ...
        for cid in c_list:
            ...
            if type_id:
                ...
                if type_id[0] not in dendo_dict[typo]:
                    ...
                    dendo_dict[typo][type_id[0]].append(dist_type_dict[type_id[0]])
...
##    test_name="sub_osp_test"
    ...
    # output_path = 'C:\\Users\\v.a.subhash.krishna\\Desktop\\Deliverable\\OSP_Rabo_Output_1\\'
