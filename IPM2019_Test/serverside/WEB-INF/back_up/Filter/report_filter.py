...
def generate_filter_df(master_df, filter_type, col_list, filter_outpath, filename, unique_df, report_type, test_name):
    filter_list = []
    ...
    if filter_type != 'All':
        if filter_type not in master_df[filter_col].unique():
            master_df = master_df.loc[master_df['tradeGroup'] == filter_type]
...
##    userid = "44"
##    filename = 'Trade_Rearrange_Usage_2021-5-2815-27-28'
##    filter_type = 'LN_BR'
##    dat = '2021-5-2815-27-28'
##    col_list = ["generator"]
##    test_name = "C_Test2"
    ...
    generate_filter_df(master_df, filter_type, col_list, filter_outpath, filename, unique_df, report_type, test_name)
