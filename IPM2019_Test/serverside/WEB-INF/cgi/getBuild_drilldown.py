        ...
        if tcode in tcode_avg_dict1:
            if tcode in tcode_avg_dict2:
                if tcode_avg_dict1[tcode][0]<tcode_avg_dict2[tcode][0]:
                    ...
                    drill_tcodes_dict[tcode]=str(round((tcode_avg_dict2[tcode][0]/1000),2))+"&"+str(round((int(round(tcode_avg_dict2[tcode][0])) - int(round(tcode_avg_dict1[tcode][0])))/int(round(tcode_avg_dict1[tcode][0])) * 100))
