...
def json_creation(json_online,json_off,rep_name,json_data,mode,appName,time_main,date_time,Imp_name,report_name):
    ...
    f.write(json_v)
    f.close()
    shutil.move(json_filename, "../../../WEB-INF/classes/static/html/"+movepath+"/"+json_filename)
    shutil.move(csv_filename, "../../../WEB-INF/classes/static/html/"+movepath+"/"+csv_filename)
    shutil.move(csv_obs, "../../../WEB-INF/classes/static/html/"+movepath+"/"+csv_obs)
    if mode == "ONL":
...
if __name__ == "__main__":
    ...
    matched_patterns = "P5,P6,P7,P8,P3,P9,P3,P4,P6,P11,P28,P29,P63"
    userid = "9"
    rep_id = "735"
    rep_name = "d5"
    Outcome = "json,csv"
    Logic = "Customization"
    logpath_file = "C:\\LAPAM2019\\DataLake\\Logs\\Cache\\9\d5\\WebSphere\\"
