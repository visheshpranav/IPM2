...
##    print(base_list)
    ...
    pos = cols.index('lastContractEventReference')
##    print(pos)
##    print(compare_list)
...
##            print(b_row[0])
            if event_values and b_row[0][pos] != "":
                flag = [val for val in event_values if val== b_row[0][pos]]
##                print(flag)
                if not len(flag):
                    continue
...
##            # print('entered')
##            result_df = result_df.append(b_row[1])
    return result_df,unique_combination_df
...
##        print(cols)
    ##    print(len(compare_master_df))
        result_df,unique_combination_df = compare_reports_master(base_master_df,compare_master_df,cols,event_values)
        if result_df.empty:
