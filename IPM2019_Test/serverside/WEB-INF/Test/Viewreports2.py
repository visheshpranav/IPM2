...
for username in ret:
        ...
        if os.path.exists(output_path):
            ...
            if os.path.exists(output_path1) and os.path.exists(output_path2) and os.path.exists(output_path3):
                    ...
                    print(z.split('\'')[3],",","DeliverableMXML/TradeInsertion/OSP",",",t[1:13].strip(),",",user_name,",",t[14:].strip())
            elif os.path.exists(output_path1) and os.path.exists(output_path2):
                    src1="NA"
                    src2="NA"
                    print(z.split('\'')[3],",","DeliverableMXML/TradeInsertion",",",t[1:13].strip(),",",user_name,",",t[14:].strip())
            elif os.path.exists(output_path1) and os.path.exists(output_path3):
                    src1="NA"
                    src3=os.listdir(output_path3+"/")
                    src3=listToString(src3)
                    print(z.split('\'')[3],",","OSP/TradeInsertion",",",t[1:13].strip(),",",user_name,",",t[14:].strip())
            elif os.path.exists(output_path2) and os.path.exists(output_path3):
                    src2="NA"
                    src3=os.listdir(output_path3+"/")
                    src3=listToString(src3)
                    print(z.split('\'')[3],",","DeliverableMXML/OSP",",",t[1:13].strip(),",",user_name,",",t[14:].strip())
            elif os.path.exists(output_path1):
                    src1="NA"
                    print(z.split('\'')[3],",","TradeInsertion",",",t[1:13].strip(),",",user_name,",",t[14:].strip())
            elif os.path.exists(output_path2):
                    src2="NA"
                    print(z.split('\'')[3],",","DeliverableMXML",",",t[1:13].strip(),",",user_name,",",t[14:].strip())
            elif os.path.exists(output_path3):
                    src3=os.listdir(output_path3+"/")
                    src3=listToString(src3)
                    print(z.split('\'')[3],",","OSP",",",t[1:13].strip(),",",user_name,",",t[14:].strip())
...
##                    src5=listToString(src5)
                    print(z.split('\'')[3],",","DATAMART",",",t[1:13].strip(),",",user_name,",",t[14:].strip())
