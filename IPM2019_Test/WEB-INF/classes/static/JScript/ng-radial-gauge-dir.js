     ...
     return {
         ...
         link: function (scope, ele, attrs) {
             ...
             d3Service.d3().then(function (d3) {
                 ...
                 var renderTimeout;
                 var width = parseInt(attrs.width) || 220;
                 var innerRadius = Math.round((width * 95) / 220);
                 var outterRadius = Math.round((width * 110) / 220);
				 
                 var majorGraduations = parseInt(attrs.majorGraduations - 1) || 5;
                 var minorGraduations = parseInt(attrs.minorGraduations) || 10;
                 var majorGraduationLenght = Math.round((width * 16) / 220);
                 var minorGraduationLenght = Math.round((width * 10) / 220);
                 var majorGraduationMarginTop = Math.round((width * 7) / 220);
                 ...
                 var valueVerticalOffset = Math.round((width * 30) / 220);
                 ...
                 var renderMajorGraduationTexts = function (majorGraduationsAngles, majorGraduationValues) {
                     ...
                     var textSize = isNaN(majorGraduationTextSize) ? (width * 12) / 220 : majorGraduationTextSize;
                 ...
                 var renderGraduationNeedle = function (minLimit, maxLimit) {
                     ...
                     if (typeof scope.value === 'undefined') {
                         ...
                         var needleRadius = (width * 2.5) / 220;
                         ...
                         var textSize = isNaN(needleValueTextSize) ? (width * 12) / 220 : needleValueTextSize;
                         var fontStyle = textSize + "px Courier";
